...
import com.skw.library.TVRecyclerViewHeaderFocus;
...
public class LinearListHeaderFocusFragment extends Fragment implements TVRecyclerView.OnLoadMoreListener {

    private String TAG = "LinearListFragment";

    private TVRecyclerViewHeaderFocus recyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_linear_list_header_focus, container, false);
            initView(view);
        }
        return view;
    }
    ...
    private void initView(View view) {
        recyclerView = (TVRecyclerViewHeaderFocus) view.findViewById(R.id.recyclerview_linear_list);
