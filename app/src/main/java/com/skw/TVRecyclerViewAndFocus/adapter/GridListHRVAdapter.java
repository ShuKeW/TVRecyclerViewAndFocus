...
public class GridListHRVAdapter extends RVAdapter<RecommendModel, Holder> {

	public GridListHRVAdapter(Context context, List<RecommendModel> mDataList) {
		super(context, mDataList);
	}

	@Override public Holder newViewHolder(ViewGroup parent, int viewType) {
		View view = mInflater.inflate(R.layout.item_grid_list_h, parent, false);
