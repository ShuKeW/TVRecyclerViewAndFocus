...
public class LinearListRVAdapter extends RVAdapter<RecommendModel, Holder> {

	public LinearListRVAdapter(Context context, List<RecommendModel> mDataList) {
		super(context, mDataList);
	}

	@Override public Holder newViewHolder(ViewGroup parent, int viewType) {
		View view = mInflater.inflate(R.layout.item_linear_list, parent, false);
