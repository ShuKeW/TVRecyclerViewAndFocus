 ...
 */
public class RecyclerViewMiddleFocus extends RecyclerViewLesports {

	public RecyclerViewMiddleFocus(Context context) {
		super(context);
	}

	public RecyclerViewMiddleFocus(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	}

	public RecyclerViewMiddleFocus(Context context, @Nullable AttributeSet attrs, int defStyle) {
